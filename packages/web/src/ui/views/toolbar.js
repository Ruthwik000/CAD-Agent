...
const toolbar = (state, i18n) => {
  ...
  const aiChatIcon = html`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><circle cx="9" cy="10" r="1"/><circle cx="15" cy="10" r="1"/><path d="M9 14c.5.5 1.5 1 3 1s2.5-.5 3-1"/></svg>`
  ...
  return html`<span id='toolbar'>
        ...
        <button id='toggleAiChat' aria-label='AI Assistant' title='AI Assistant'>
          ${aiChatIcon}
        </button>
